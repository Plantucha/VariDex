...
def run_complete_pipeline(
    ...
    # Calculate coverage
    all_codes = ['PVS1', 'PS1', 'PM2', 'PM4', 'PM5', 'PP2', 'PP5',
    ...
    print(f"  With evidence: {stats['variants_with_evidence']:,} ({stats['coverage']:.1f}%)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--genome", help="User genome file (auto-detect if not specified)")
    parser.add_argument("--clinvar", default="clinvar/clinvar_GRCh37.vcf.gz", help="ClinVar VCF file")
    parser.add_argument("--gnomad", default="gnomad_v3.1_GRCh37_cleaned.csv", help="gnomAD CSV file")
    parser.add_argument("--output", default="output", help="Output directory")
    parser.add_argument("--no-phase1", action="store_true", help="Disable Phase 1 enhancements")
